...
async function runJob() {
  ...
  for (const statusEvent of statusEvents) {
    ...
    if (doesMatch) {
      const status_text = statusEvent.check_for_status_in_title ? checkSubjectForTitle(primaryEvent.subject) : statusEvent.status_text;
      SlackService.updateStatus(status_text, statusEvent.status_emojis, endTime);
      return;
    }
  }
